                            ...
                            <?php
                                ...
                                if (isset($_POST['save'])) {
                                    if ($_POST['title'] != "") {                                        
                                        ...
                                        $ins = "INSERT INTO vdo (semester_id, subject_id, exam_id, title, url, status, admin_id) VALUES ('$semester_id', '$subject_id', '$exam_id', '$title', '$url', '1', '$admin_id');";    

                                        if (mysqli_query ($link, $ins)) {           
                                            echo "<script>";
                                            echo "self.location='vdo_list.php?msg=<font color=green>Added Success!</font>';";
                                            echo "</script>";
                                        } else {
                                            echo "no ins";
                                        }
                            ...
                            <div class="card-body">
                                <form action="#" method="post">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input name="title" class="form-control form-control-lg" type="text" placeholder="Video Title" autocomplete="off" required>
                                        <br>
                                        <input name="url" class="form-control form-control-lg" type="text" placeholder="Video URL" autocomplete="off" required>
